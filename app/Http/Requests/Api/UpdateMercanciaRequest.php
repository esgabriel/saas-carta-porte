...
class UpdateMercanciaRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'viaje_id' => ['sometimes', 'required', 'exists:viajes,id'],
            'clave_prod_stcc' => ['sometimes', 'required', 'string', 'max:10'],
            'descripcion' => ['sometimes', 'required', 'string', 'max:1000'],
            'cantidad' => ['sometimes', 'required', 'numeric', 'min:0'],
            'clave_unidad' => ['sometimes', 'required', 'string', 'max:5'],
            ...
            'peso_en_kg' => ['sometimes', 'required', 'numeric', 'min:0'],
